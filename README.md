...
Congratulations! Now you can run the code on the esp-32, open the serial monitor, calibrate the values and start using the program. You can tap into the web server by connecting to the esp-32 wifi
it has a visual representation of the container with a live water level reading.
